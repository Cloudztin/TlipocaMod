...
public class PlaySameInstanceAction extends AbstractGameAction {
    AbstractCard card;
    public Consumer<AbstractCard> cardConsumer;

    public PlaySameInstanceAction(AbstractCard card, Consumer<AbstractCard> cardConsumer) {
        this.card = card;
        this.cardConsumer = cardConsumer;
    }


    public PlaySameInstanceAction(AbstractCard card) {
