...
public class hllBlankCard extends AbstractHaaLouLingCard {

    static final CardRarity rarity = CardRarity.RARE;
    static final CardType type = CardType.SKILL;
    static final int cost = 1;
    static final String cardName = "BlankCard";
    ...
    public boolean canUse(AbstractPlayer p, AbstractMonster m) {
        ...
        if (!canUse)
            return false;
        if (this.getLastCardPlayedThisCombat() == null) {
    ...
    public void update() {
        ...
        if (this.hb.hovered)
            if (getLastCardPlayedThisCombat() != null)
                this.cardsToPreview = getLastCardPlayedThisCombat().makeSameInstanceOf();
    }
